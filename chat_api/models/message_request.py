...
class MessageRequest(models.Model):
    ...
    # Added to support unified system prompt separate from role/content (multi-provider)
    ...
    request_user_content = models.TextField(blank=True, null=True) #ACTUAL USER MESSAGE
